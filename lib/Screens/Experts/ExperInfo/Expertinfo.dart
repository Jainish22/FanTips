...
class ExpertInfo extends StatefulWidget {
  ExpertInfo({required this.name, required this.pre, required this.sub, required this.wins, required this.backgroundImage, required this.ave});
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: const [Tab(text: AppString.info), Tab(text: AppString.matches)],
          ),
        ),
        body: TabBarView(
          children: [
